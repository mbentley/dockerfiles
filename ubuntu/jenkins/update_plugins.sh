...
plugins="cobertura greenballs instant-messaging ircbot postbuild-task copy-to-slave credentials ssh-credentials ssh-agent git-client git github-api github scm-api mercurial grails"
